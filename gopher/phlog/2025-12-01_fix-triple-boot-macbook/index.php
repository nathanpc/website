...
<head>
	...
	<!-- Page information. -->
	<title>Fixing the BlInitializeLibrary Failed Boot Error on a MacBook</title>
</head>
<body>
	<?php include_template('header'); ?>

	<div id="blog-post" class="section">
		<h2>Fixing the BlInitializeLibrary Failed Boot Error on a MacBook</h2>
		<div id="published-date">2025-12-01 - <a href="gopher://nathancampos.me/0/phlog/2025-12-01_fix-triple-boot-macbook/post.txt">Also available on Gopher</a></div>
	</div>

<pre id="plain-text">Today as I was ready to get some work done on the machine I regard as the
ultimate laptop, a MacBook Air 13-inch from 2017 [<a href="https://everymac.com/systems/apple/macbook-air/specs/macbook-air-core-i5-1.8-13-2017-specs.html">1</a>], I rebooted into rEFInd [<a href="https://www.rodsbooks.com/refind/">2</a>]
and chose my Windows partition, only to be greeted by this lovely message:

<code>Starting bootmgfw.efi
Using load options ''
BlInitializeLibrary failed 0xc00000bb</code>
...
on a 64-bit UEFI-based computer" [<a href="https://learn.microsoft.com/en-us/troubleshoot/windows-client/setup-upgrade-and-drivers/blinitializelibrary-failed-start-os-on-64-bit-uefi-based-computer">3</a>], which in its cause section describes the
problem as follows:

<code>This problem occurs because the boot firmware on the computer generates lots
of memory fragmentation.</code>
...
<code>We recommend that you do not let boot firmware create large amounts of
fragmentation. Large memory fragmentation degrades the overall startup
performance and causes problems.</code>
...
direction [<a href="https://apple.stackexchange.com/a/325875">4</a>].
...
First thing to do was disable Mac OS X's System Integrity Protection (SIP) [<a href="https://developer.apple.com/documentation/security/disabling-and-enabling-system-integrity-protection">5</a>],
which protects you from doing dumb things with the root filesystem. Then I had
to download the amazing GPT fdisk [<a href="https://www.rodsbooks.com/gdisk/">6</a>] from the same guy that made rEFInd.

Upon opening GPT fdisk I was greeted with the following output:

<code>$ sudo gdisk /dev/disk0
...
<code>GPT fdisk (gdisk) version 1.0.10
...
[1]: <a href="https://everymac.com/systems/apple/macbook-air/specs/macbook-air-core-i5-1.8-13-2017-specs.html">https://everymac.com/systems/apple/macbook-air/specs/macbook-air-core-i5-1.8-13-2017-specs.html</a>
[2]: <a href="https://www.rodsbooks.com/refind/">https://www.rodsbooks.com/refind/</a>
[3]: <a href="https://learn.microsoft.com/en-us/troubleshoot/windows-client/setup-upgrade-and-drivers/blinitializelibrary-failed-start-os-on-64-bit-uefi-based-computer">https://learn.microsoft.com/en-us/troubleshoot/windows-client/setup-upgrade-and-drivers/blinitializelibrary-failed-start-os-on-64-bit-uefi-based-computer</a>
[4]: <a href="https://apple.stackexchange.com/a/325875">https://apple.stackexchange.com/a/325875</a>
[5]: <a href="https://developer.apple.com/documentation/security/disabling-and-enabling-system-integrity-protection">https://developer.apple.com/documentation/security/disabling-and-enabling-system-integrity-protection</a>
[6]: <a href="https://www.rodsbooks.com/gdisk/">https://www.rodsbooks.com/gdisk/</a>
</pre>
