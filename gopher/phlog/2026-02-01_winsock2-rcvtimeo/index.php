...
<head>
	...
	<!-- Page information. -->
	<title>It has been 0 days since I was bitten by a WinSock2 bug</title>
</head>
<body>
	<?php include_template('header'); ?>

	<div id="blog-post" class="section">
		<h2>It has been 0 days since I was bitten by a WinSock2 bug</h2>
		<div id="published-date">2026-02-01 - <a href="gopher://nathancampos.me/0/phlog/2026-02-01_winsock2-rcvtimeo/post.txt">Also available on Gopher</a></div>
	</div>
