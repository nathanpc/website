...
<head>
	...
	<!-- Page information. -->
	<title>StarFive VisionFive 2 Lite: First Impression</title>
</head>
<body>
	<?php include_template('header'); ?>

	<div id="blog-post" class="section">
		<h2>StarFive VisionFive 2 Lite: First Impression</h2>
		<div id="published-date">2025-12-07 - <a href="gopher://nathancampos.me/0/phlog/2025-12-07_vf2-lite-first-impression/post.txt">Also available on Gopher</a></div>
	</div>
